...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'check_in': 'Check In',
      'check_out': 'Check Out',
      'web_location_notice': 'Location Services Unavailable',
      'web_location_message':
          'Location services are not available on web platform. Continue without location?',
      'continue_without_location': 'Continue',
      ...
      // Attendance/Location
      'location_required': 'Location is required for attendance',
      ...
      'location_permission_message':
          'Please enable location permission to record attendance with GPS coordinates',
      'enable_location': 'Enable Location',
      'error_getting_location': 'Error getting location',
      'punch_in_success': 'Successfully punched in',
      'punch_out_success': 'Successfully punched out',
      'punch_in_failed': 'Failed to punch in',
      'punch_out_failed': 'Failed to punch out',
    ...
    'fr': {
      ...
      'no_attendance_records': 'Aucun enregistrement de pointage trouvé',
      'check_in': 'Arrivée',
      'check_out': 'Départ',
      'web_location_notice': 'Services de localisation indisponibles',
      'web_location_message':
          'Les services de localisation ne sont pas disponibles sur la plateforme web. Continuer sans localisation?',
      'continue_without_location': 'Continuer',
      ...
      // Attendance/Location
      'location_required': 'La localisation est requise pour le pointage',
      ...
      'location_permission_message':
          'Veuillez activer la permission de localisation pour enregistrer le pointage avec les coordonnées GPS',
      'enable_location': 'Activer la localisation',
      'error_getting_location':
          'Erreur lors de la récupération de la localisation',
      'punch_in_success': 'Pointage d\'entrée réussi',
      'punch_out_success': 'Pointage de sortie réussi',
      'punch_in_failed': 'Échec du pointage d\'entrée',
      'punch_out_failed': 'Échec du pointage de sortie',
      'last_attendance': 'Dernier Pointage',
      'checked_in': 'Entrée enregistrée',
      'checked_out': 'Sortie enregistrée',
    ...
    'ar': {
      ...
      'web_location_notice': 'خدمات الموقع غير متاحة',
      'web_location_message':
          'خدمات الموقع غير متاحة على منصة الويب. متابعة بدون موقع؟',
      'continue_without_location': 'متابعة',
      ...
      'location_permission_message':
          'يرجى تفعيل إذن الموقع لتسجيل الحضور بإحداثيات GPS',
      'enable_location': 'تفعيل الموقع',
      'error_getting_location': 'خطأ في الحصول على الموقع',
      'punch_in_success': 'تم التسجيل بنجاح',
      'punch_out_success': 'تم تسجيل الخروج بنجاح',
      'punch_in_failed': 'فشل تسجيل الدخول',
      'punch_out_failed': 'فشل تسجيل الخروج',
