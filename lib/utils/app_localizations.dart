...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'search_employees_reports': 'Search employees, reports...',
      ...
      'schedule': 'Schedule',
      'team_size': 'Team Size',
      'pending_approvals_status': 'Pending',
      'approved_this_week': 'This Week',
    ...
    'fr': {
      ...
      'search_employees_reports': 'Rechercher des employés, rapports...',
      ...
      'pending_approvals_status': 'En Attente',
      'approved_this_week': 'Cette Semaine',
      'team_productivity': 'Productivité',
      ...
      'punch_in_out': 'Pointage (Entrée / Sortie)',
      'time_tracking_history': 'Historique de mes pointages',
      'punch_history': 'Historique de mes pointages',
    ...
    'ar': {
      ...
      'search_employees_reports': 'البحث عن الموظفين والتقارير...',
      ...
      'pending_approvals_status': 'معلقة',
      'approved_this_week': 'هذا الأسبوع',
      'team_productivity': 'الإنتاجية',
      ...
      'unexpected_absence': 'غياب غير متوقع',
      'working_time': 'وقت العمل',
      'work_time': 'وقت العمل',
      'time_tracking': 'التوقيت (الدخول / الخروج)',
      'punch_in_out': 'التوقيت (الدخول / الخروج)',
      'time_tracking_history': 'سجل التوقيت الخاص بي',
      'punch_history': 'سجل التوقيت الخاص بي',
